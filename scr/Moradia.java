// a interface é como se fosse um contrato que obriga que qualquer que classe que a use tenha que seguir umas dadas instruções para a sua realização
...
// interface que obriga que se Imposto for usado é necessário recorrer á função calculaImposto(), caso contrário não funcioan
interface Imposto {
